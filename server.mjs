...
async function submitGeneration({ prompt, subjectDataUrl, refDataUrls, width, height }, parentRecordId) {
  ...
  const payload = {
    ...
    seed: 42,
    prompt: 'refer to this image: copy ONLY the face identity, skin tone, and hair color from img1, but take the EXACT head position, pose, and body proportions and body position from img2, replicate the exact background, angle and lighting from img2, amateur photo, natural lighting, visible skin texture, no text overlay, slim body.',
